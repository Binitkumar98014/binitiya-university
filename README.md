...
<center> How many dots can you hit in 30 seconds?</center>
<form name="cpanel">
<center>
<table cellspacing=3>
<tr>
<td><input type="button" name="startstop" value=" Start|Stop" onClick="play()"></td>
<td><pre>    </pre></td>
...
</tr></table> <a href="instruct.html">Insturctions</a></div> </center></form>
